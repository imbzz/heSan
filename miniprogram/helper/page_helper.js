 ...
 function getSkin() {
 	return {
        ...
        NEWS_CATE: '1=广州大学城|leftpic,2=广州大学城南|leftpic',
        NEW_CATE_TWO:'1=大学城外环西路|leftpic,2=大学城北亭|leftpic',
        NEW_CATE_Three:'1=广州大学|leftpic,2=北亭|leftpic',
 ...
 function formClearFocus(that) {
 	...
 	that.setData({//将that中form开头的对象名称后面加上Focus,用console.log(focus)可查看
 		...focus
     });
 }
