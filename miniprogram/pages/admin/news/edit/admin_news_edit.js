...
Page({
	...
	onLoad: async function (options) {
        ...
        this.setData(await AdminNewsBiz.initFormData());
        await this._loadDetail();
		if (!pageHelper.getOptions(this, options)) return;
        this.setData({
            formAdminName:options.name,
			isLoad: true
		});
		this._loadDetail();
	},
	...
	_loadDetail: async function () {
		...
		this.setData({
            ...
            // formCateIdTwo: news.NEWS_CATE_ID_TWO,
            // formCateIdThree: news.NEWS_CATE_ID_THREE,
            formTitleRemark:news.NEWS_TITLE_REMARK,
            // formTitleTime:news.NEWS_TITLE_TIME,
            formMobile:news.NEWS_MOBILE,
            ...
            formDaysSet:news.NEWS_DAYS_SET,
		}, () => {
	...
	bindFormSubmit: async function () {
        ...
        // data.cateNameTwo = AdminNewsBiz.getCateNameTwo(data.cateIdTwo);
        // data.cateNameThree = AdminNewsBiz.getCateNameThree(data.cateIdThree);
        console.log(data);
		try {
